...
package id.kalakian.boot.raygun.example.web;

import id.kalakian.boot.raygun.RaygunTemplate;
import id.kalakian.boot.raygun.example.CaughtRaygunException;
import id.kalakian.boot.raygun.example.UncaughtRaygunException;
